...
def test_encode_sequence_with_method():
	...
	method = 'One-Hot'
	# try:
	encoded_seq = test.encode_sequence_with_method(trial_promoter, method)
...
def test_resize_array():
	...
	edit_front = True
	# try:
	out_1 = test.resize_array(trial_seq, max_len, edit_front)
	# except Exception as e:
	...
	max_len = 5
	# try:
	out_2 = test.resize_array(trial_seq, max_len, edit_front)
	# except Exception as e:
	# 	assert isinstance(e, TypeError)
	...
	max_len = 7
	# try:
	out_3 = test.resize_array(trial_seq, max_len, edit_front)
	# except Exception as e:
		# assert isinstance(e, TypeError)
	...
	edit_front_2 = False
	# try:
	out_4 = test.resize_array(trial_seq_2, max_len_2, edit_front_2)
	# except Exception as e:
		# assert isinstance(e, TypeError)
