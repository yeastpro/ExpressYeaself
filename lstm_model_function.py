...
def lstm_training(data_path):
    ...
    score, predict_data=lstm_model_on_one_hot_sequence(bp_number, training_sequence, training_output, testing_sequence, testing_output, self_loss='mean_squared_error',learning_rate=0.01, epochs_value=2, batch_size_value=50)
